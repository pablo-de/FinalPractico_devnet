...
respOrg = requests.get(url_org, headers=headers, verify=False)
...
respNetwork = requests.get(url_redes, headers=headers, verify=False)
...
respDevice = requests.get(url_devices, headers=headers, verify=False)
...
respNetworkID = requests.get(url_NetworkID, headers=headers, verify=False)
...
respDeviceID = requests.get(url_DeviceID, headers=headers, verify=False)
...
repSSID = requests.get(url_SSID, headers=headers, verify=False)
